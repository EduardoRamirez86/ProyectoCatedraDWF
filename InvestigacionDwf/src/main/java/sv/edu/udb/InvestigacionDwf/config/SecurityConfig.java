    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/auth/ropa/**", "/auth/producto/**", "/auth/tipoproducto/**", "/auth/carrito/**" , "auth/carrito-item/**" , "auth/pedido/**", "/auth/resenas/**", "/auth/notificacion/**", "/auth/direcciones/**").permitAll()
